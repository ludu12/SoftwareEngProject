...
public class CarAudio : MonoBehaviour
{
    ...
    private CarMotor m_carMotor; // Reference to car we are controlling


    private void StartSound()
    {
        // get the CarMotor ( this will not be null as we have require component)
        m_carMotor = GetComponent<CarMotor>();
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, m_carMotor.Revs);
            ...
            else
            {
                ...
                float accFade = Mathf.Abs(m_carMotor.AccelInput);
                float decFade = 1 - accFade;

                // get the high fade value based on the cars revs
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_carMotor.Revs);
